...
function init() {
  ...
  for (var i = 0; i < numGrids; i++) {
    var _grid = new _grid3.default(gridsContainer, i);
...
},{"./canvas/grid":8,"gsap":1,"lodash":2,"moment":3}],5:[function(require,module,exports){
"use strict";
...
},{"./grid":9,"gsap":1}],6:[function(require,module,exports){
"use strict";
...
},{"./CanvasVersion":4,"./HTMLVersion":5}],7:[function(require,module,exports){
"use strict";
...
var Caleido = function () {
  ...
  _createClass(Caleido, [{
    ...
    key: "buildFirstBorder",
    value: function buildFirstBorder(width, height) {
    ...
    key: "buildSecondBorder",
    value: function buildSecondBorder() {
    ...
    key: "buildThirdBorder",
    value: function buildThirdBorder() {
    ...
    key: "buildBorder",
    value: function buildBorder(width, height, position) {
    ...
    key: "buildMask",
    value: function buildMask(width, height) {
    ...
    value: function show() {
      ...
      for (var s = 0; s < this.secondBorders.length; s++) {
        var _border = this.secondBorders[s];
        TweenMax.to(_border.circle, 1.9, { x: _border.circle._x, y: _border.circle._y, ease: Expo.easeInOut, delay: 0.6 });
      }

      for (var t = 0; t < this.thirdBorders.length; t++) {
        var _border2 = this.thirdBorders[t];
        TweenMax.to(_border2.circle, 2.3, { x: _border2.circle._x, y: _border2.circle._y, ease: Expo.easeInOut, delay: 0.65 });
      }
    }
  }, {
    key: "hide",
...
var _caleido = require("./caleido");

var _caleido2 = _interopRequireDefault(_caleido);
  ...
  _createClass(Grid, [{
    ...
    value: function animate() {
      if ((0, _moment2.default)().month() === this.month) {
        ...
        _lodash2.default.delay(this.showCaleido.bind(this), 3000);
      }
    }
  }, {
    key: "showCaleido",
    value: function showCaleido() {
      this.caleido.show();
    }
  }, {
    key: "addCaleido",
    ...
    value: function buildDays() {
      ...
      var diff = (0, _moment2.default)().month() - this.month;
      var date = (0, _moment2.default)().subtract(14 * diff, 'days');
...
},{"./caleido":7,"lodash":2,"moment":3}],9:[function(require,module,exports){
"use strict";
